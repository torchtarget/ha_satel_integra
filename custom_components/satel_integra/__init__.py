...
PLATFORMS = [Platform.ALARM_CONTROL_PANEL, Platform.BINARY_SENSOR, Platform.SWITCH]  # Platform.SENSOR disabled - temperature detection kills connection
...
async def async_setup_entry(hass: HomeAssistant, entry: SatelConfigEntry) -> bool:
    ...
    # Load platforms first (v0.4.0 order - reverted from v0.6.x temperature detection change)
